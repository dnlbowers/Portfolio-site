...
class ClientProject(models.Model):
    ...
    grant_access_to = models.ManyToManyField(
        User, related_name="permitted_to_access")
...
class ProjectFiles(models.Model):
    related_project = models.ForeignKey(
        ...
        blank=True,
        null=True)
    Initial_contract = models.FileField(
        upload_to='contract/', blank=True, null=True)
    addendum = models.FileField(upload_to='addendum/', blank=True, null=True)
    wireframes = models.FileField(
        upload_to='wireframes/', blank=True, null=True)
    color_mockup = models.FileField(
        upload_to='color_mockup/', blank=True, null=True)
    planning_docs = models.FileField(
        upload_to='planning_docs/', blank=True, null=True)
    official_docs = models.FileField(
        upload_to='official_docs/', blank=True, null=True)
